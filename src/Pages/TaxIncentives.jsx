  ...
  return(<>
    ...
    <div>
      ...
      <p>At the national level, there are plenty of tax incentives for adding green energy systems to your home. For one, homeowners can save up to
        ...
        save up to $2,000 (30% of the cost) on said upgrade. You can also save $1,200 (30% of the cost) on other improvements including but not limited to windows, insulation, 
        water heaters, AC systems, and electric panel upgrades. You can claim these credits through&nbsp;
        <a target='_blank' href='https://www.irs.gov/pub/irs-pdf/f5695.pdf' rel='noreferrer'><b>IRS Form 5695</b></a>. Click the dropdown below to see 
        a more extensive list of incentives.
      </p>
    </div>
    <div className = 'national-table-dropdown'>
          ...
          <table className = "nationalTable">
            <thead>
              <tr>
                ...
                <th className='moreInfo'>More Information</th>
              </tr>
            </thead>
            <tbody>
              {data.map((value, key) => {
